      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <h5 class="centered">Risdhi Laksna</h5>
                  ...
                  <a href="<?=base_url('index.php/Pelanggan/DaftarPelanggan')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/house.png" class="img-circle" style="width: 30px;"><div style="margin-right: 85px; margin-top: -33px; font-size: 15px; float: right;">Form Data Pembeli</div></p>
              ...
              <a href="<?=base_url('index.php/Pelanggan')?>">
                  <p class="material-icons" ><img src="<?=base_url()?>assets/house.png" class="img-circle" style="width: 30px;"><div style="margin-right: 85px; margin-top: -33px; font-size: 15px; float: right;">Data Pelanggan</div></p>
