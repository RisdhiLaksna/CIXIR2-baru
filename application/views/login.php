	...
	<!-- <form action="<?base_url('index.php/User/Login')?>" method="post">
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action="<?=base_url('index.php/User/Login')?>" id="sign_in" method="POST">
		        ...
		        <div class="login-wrap">
		            ...
		            <label class="checkbox">
		                <span class="pull-right">
		                    <a data-toggle="modal" href="<?= base_url()?>login.html#myModal"> Forgot Password?</a>
