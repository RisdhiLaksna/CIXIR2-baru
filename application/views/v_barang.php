        ...
        <div class="header">
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-6">
                 -->
                <h1 class=" " style="color: #000; margin-left: 3px;">Barang</h1>
            ...
            <div class="body">
            <div class="row"> -->
            <a style="margin: 35px; margin-left: 1px;" href="#tambah" class="btn btn-primary" data-toggle="modal"><span class="glyphicon-plus"></span>Tambah</a>
                <table style="color: #000; "  class="table table-hover table-striped">
                <tr>
