...
<h1 style="text-align:left; color: #000; margin-left: 5px;">Kategori</h1>                                 
<!-- </div>                         
</div>                         
<div class="body">                        
 <div class="row">                          -->
...
<?php endif ?>                          
   ...
   <div class="modal-dialog">    
    ...
    <div class="modal-header">        
     <button type="button" class="close" data-dismiss="modal"><span ariahidden="true">&times;</span>
     <span class="sr-only">Close</span></button>         
     <h4 class="modal-title">Tambah Kategori</h4> 
      </div>       
      <div class="modal-body">         
      <form action="<?=base_url('index.php/kategori/simpan_kategori')?>" method="post"> Nama Kategori         
